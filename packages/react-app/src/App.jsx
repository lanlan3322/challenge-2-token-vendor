  ...
  return (
    <div className="App">
        ...
        <Switch>
          <Route exact path="/">
            <div style={{ padding: 8, marginTop: 32, width: 300, margin: "auto" }}>
              <Card title="Your CH2 balance" extra={<a href="#">code</a>}>
                <div style={{ padding: 8 }}>
            ...
            <Divider />
            <div style={{ padding: 8, marginTop: 32, width: 300, margin: "auto" }}>
              <Card title="Buy CH2" extra={<a href="#">code</a>}>
            ...
            <div style={{ padding: 8, marginTop: 32 }}>
              <div>Vendor CH2 Balance:</div>
              <Balance balance={vendorTokenBalance} fontSize={64} /> CH2
            </div>
      ...
      <div style={{ marginTop: 32, opacity: 0.5 }}>
        Created by <Address value={"zhanglaurence.eth"} ensProvider={mainnetProvider} fontSize={16} />
      </div>
